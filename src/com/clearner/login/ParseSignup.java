...
public class ParseSignup extends Clearner implements OnClickListener {
	...
	private void login() {
		...
		if (onEmpty(email, password, name, mobile)) {
			Clearner.toastShow("Please enter the details", getApplicationContext());
		} else {
		...
		user.signUpInBackground(new SignUpCallback() {
			...
			public void done(ParseException e) {
				...
				if (e == null) {
					...
					// Signup successful!
					Clearner.toastShow("Your account logged", getApplicationContext());
					navigateToHome();
	...
	private boolean onEmpty(String login, String password, String name,
			String number) {
