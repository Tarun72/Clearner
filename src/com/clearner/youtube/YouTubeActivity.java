...
/*        if (ApiKey.YOUTUBE_API_KEY.startsWith("AIzaSyADmK_tHmM1nd0kf2m6jka4H79lJrdx0V0")) {
            AlertDialog.Builder builder = new AlertDialog.Builder(this)
                .setMessage("Edit ApiKey.java and replace \"AIzaSyADmK_tHmM1nd0kf2m6jka4H79lJrdx0V0\" with your Applications Browser API Key")
